...
export const updateComments = (id, subComment) => firebase
  .firestore()
  .collection('post')
  .doc(id)
  ...
  firebase.firestore().collection('posts')
    ...
    .then((querySnapshot) => {
      querySnapshot.forEach((post) => {
        ...
        const data = new Date(database.time);
          ...
          <div class='date-posts'>
            ...
            <div class="buttons-social">
              ...
              <button id='${post.id}' class='btn-like'>
                <img src="/images/favorite.svg" class="favorite-icon">
              </button>
              <button id="button-delete"class='button-delete-${post.id}' data-delete='${post.id}'>
                <img src="/images/trash.svg" class="delete-icon">
              </button>
            <div>
